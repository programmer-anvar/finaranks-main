"use client"
import { BalanceSheetSchema } from "@/mocks/stock-financial";
...
const BalanceSheetTable = ({ _, view, newData }: any) => {
    ...
    useEffect(() => {
        setTreeDataValue({ treeValue: TreeState.create(buildFromSchema(BalanceSheetSchema, newData.financial_data[view])) })
    ...
    return (
        <div className="financials-table w-full">
            <div className="w-full overflow-x-auto overflow-y-hidden rounded-xl border border-white/10">
                <div className="min-w-[980px] md:min-w-[1100px]">
                    <TreeTable
                        height={tableHeight}
                        headerHeight={52}
